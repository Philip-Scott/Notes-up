...
echo "Icon=/home/felipe/code/notes-up/vala/data/enotes.svg" >> /home/$(whoami)/.local/share/applications/Notes.desktop
...
valac-0.28 --pkg gtk+-3.0 --pkg webkit2gtk-3.0 --pkg granite --pkg gtksourceview-3.0 --thread --target-glib 2.32 \
src/Main.vala src/Application.vala \
